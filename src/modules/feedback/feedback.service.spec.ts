...
describe('FeedbackService', () => {
  ...
  it('creates feedback without attachment', () => {
    const result = service.createFeedback(dto);
    expect(result.id).toBeDefined();
    expect(result.createdAt).toBeDefined();
    expect(result.attachment).toBeNull();
  });

  it('creates feedback with attachment', () => {
    ...
    const result = service.createFeedback(dto, attachment);
